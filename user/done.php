...
if($_SESSION['sure']){
   ...
   header('Location: /');
       ...
       if(isset($_POST['go-submit']) && ($_SERVER['REQUEST_METHOD'] == 'POST'))
          if($_POST['number'] == $number){
             ...
             echo '</div>';
                 ...
                 echo '<br />';
                 echo '<input type="submit" id="submit" name="go-submit" class="button color-teal panel-round-xxl pad-15" value="Xác nhận" />';
                 echo '</form>';
                 echo '</div>';
              }
       ...
       ?>
         ...
         <div class="color-pale-red mar-5 pad-10 size-text-20">
